...
export const allExercises: { [key: string]: { name: string; description: string } } = {
  ...
  '4-6': { name: 'Sole Weave', description: 'Weave the ball using the sole of your foot in a flowing pattern' },
  '4-7': { name: 'Inside Outside Weave', description: 'Weave the ball using both inside and outside of your foot' },
